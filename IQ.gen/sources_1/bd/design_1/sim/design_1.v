...
module design_1
  ...
  wire pcie_reset;
  wire [23:0]selectio_to_axis_0_m_axis_tdata;
  wire selectio_to_axis_0_m_axis_tlast;
  ...
  design_1_axis_dwidth_converter_0_0 axis_dwidth_converter_0
       (.aclk(selectio_wiz_0_clk_out),
        ...
        .s_axis_tdata(selectio_to_axis_0_m_axis_tdata),
        .s_axis_tlast(selectio_to_axis_0_m_axis_tlast),
  ...
  design_1_ila_1_0 ila_1
       (.clk(selectio_wiz_0_clk_out),
        .probe0({selectio_to_axis_0_m_axis_tlast,selectio_to_axis_0_m_axis_tlast,selectio_to_axis_0_m_axis_tlast,selectio_to_axis_0_m_axis_tlast}),
        .probe1({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,selectio_to_axis_0_m_axis_tdata}));
  ...
  design_1_selectio_to_axis_dual_0_0 selectio_to_axis_dual_0
       (.clk(selectio_wiz_0_clk_out),
        ...
        .m_axis_tdata(selectio_to_axis_0_m_axis_tdata),
        .m_axis_tlast(selectio_to_axis_0_m_axis_tlast),
        .m_axis_tready(axis_dwidth_converter_0_s_axis_tready),
        .rst_n(pcie_reset));
