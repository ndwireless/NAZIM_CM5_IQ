...
HD_PWD='C:/VIVADO_PROJECTS/IQ/IQ.runs/design_1_selectio_to_axis_dual_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_selectio_to_axis_dual_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_selectio_to_axis_dual_0_0.tcl
